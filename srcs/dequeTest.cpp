...
void	print_std_vec(std::deque<int>& vec)
{
...
void	print_ft_vec(ft::deque<int>& vec)
{
	std::cout << "[ft]" << std::endl;
	size_t i = 0;
	for (ft::deque<int>::iterator it = vec.begin(); it != vec.end(); it++) {
		std::cout << *it << " ";
		if ((i + 1) % 10 == 0 && i != vec.size() - 1)
			std::cout << std::endl;
		i++;
...
void	dequeTest()
{
...

	{
		...
		std::deque<int> std_vec(10, 3);
		ft::deque<int> ft_vec(10, 3);
		print_std_vec(std_vec);
		print_ft_vec(ft_vec);
		...
		std::cout << "[std]" << std::endl;
		i = 0;
		for (std::deque<int>::iterator it = std_vec.begin(); it != std_vec.end(); it++) {
			std::cout << *it << " ";
		...
		std::cout << "[ft]" << std::endl;
		i = 0;
		for (ft::deque<int>::iterator it = ft_vec.begin(); it != ft_vec.end(); it++) {
			std::cout << *it << " ";
		...
		std::cout << "[std]" << std::endl;
		i = 0;
		for (std::deque<int>::reverse_iterator it = std_vec.rbegin(); it != std_vec.rend(); it++) {
			std::cout << *it << " ";
			if ((i + 1) % 10 == 0 && i != std_vec.size())
				std::cout << std::endl;
			i++;
		...
		std::cout << "[ft]" << std::endl;
		i = 0;
		for (ft::deque<int>::reverse_iterator it = ft_vec.rbegin(); it != ft_vec.rend(); it++) {
			std::cout << *it << " ";
			if ((i + 1) % 10 == 0 && i != ft_vec.size())
				std::cout << std::endl;
			i++;
		}
		std::deque<int> std_vec_const(std_vec);
		ft::deque<int> ft_vec_const(ft_vec);
		std::cout << "const iterator" << std::endl;
		std::cout << "[std]" << std::endl;
		i = 0;
		for (std::deque<int>::const_iterator it = std_vec_const.begin(); it != std_vec_const.end(); it++) {
			std::cout << *it << " ";
		...
		std::cout << "[ft]" << std::endl;
		i = 0;
		for (ft::deque<int>::const_iterator it = ft_vec_const.begin(); it != ft_vec_const.end(); it++) {
			std::cout << *it << " ";
		...
		std::cout << "[std]" << std::endl;
		i = 0;
		for (std::deque<int>::const_reverse_iterator it = std_vec_const.rbegin(); it != std_vec_const.rend(); it++) {
			std::cout << *it << " ";
			if ((i + 1) % 10 == 0 && i != std_vec_const.size())
				std::cout << std::endl;
			i++;
		...
		std::cout << "[ft]" << std::endl;
		i = 0;
		for (ft::deque<int>::const_reverse_iterator it = ft_vec_const.rbegin(); it != ft_vec_const.rend(); it++) {
			std::cout << *it << " ";
			if ((i + 1) % 10 == 0 && i != ft_vec_const.size())
				std::cout << std::endl;
			i++;
...

	{
		...
		std::deque<int> std_vec_base;
		ft::deque<int> ft_vec_base;
		for (size_t i = 0; i < 20; i++) {
			int val = rand() % 200 - 100;
		...
		std::deque<int> std_vec(std_vec_base.begin() + 3, std_vec_base.end() - 3);
		ft::deque<int> ft_vec(ft_vec_base.begin() + 3, ft_vec_base.end() - 3);
...

	{
		...
		print_std_vec(std_vec);
		print_ft_vec(ft_vec);
		std::deque<int> std_vec_copy1(std_vec);
		ft::deque<int> ft_vec_copy1(ft_vec);
		std::cout << "created by copy constructor" << std::endl;
		print_std_vec(std_vec_copy1);
		print_ft_vec(ft_vec_copy1);
		std::deque<int> std_vec_copy2;
		ft::deque<int> ft_vec_copy2;
...

	{
		...
		std::deque<int> std_vec1;
		ft::deque<int> ft_vec1;
		std::cout << "[std] size: " << std_vec1.size() << std::endl;
		std::cout << "[ft] size: " << ft_vec1.size() << std::endl;
...
//		std::deque<int> std_vec1(3, 5);
//		ft::deque<int> ft_vec1(3, 5);
//		print_std_vec(std_vec1);
//		print_ft_vec(ft_vec1);
...
//		print_std_vec(std_vec1);
//		print_ft_vec(ft_vec1);
//		std::cout << "with custom objects deque" << std::endl;
//		std::deque<Test> std_vec_obj;
//		ft::deque<Test> ft_vec_obj;
...
//		std::cout << "[std] vec: ";
//		for (std::deque<Test>::iterator it = std_vec_obj.begin(); it != std_vec_obj.end(); it++)
//			std::cout << *it << " ";
//		std::cout << std::endl;
//		std::cout << "[ft] vec: ";
//		for (ft::deque<Test>::iterator it = ft_vec_obj.begin(); it != ft_vec_obj.end(); it++)
//			std::cout << *it << " ";
//		std::cout << std::endl;
...
//		std::deque<int> std_vec_base(6, 100); std_vec_base.push_back(500);
//		ft::deque<int> ft_vec_base(6, 100); ft_vec_base.push_back(500);
//		std::deque<int> std_vec;
//		ft::deque<int> ft_vec;
...
//	system("clear");

	{
		...
		std::deque<int> std_vec_base(4, 100); std_vec_base.push_back(500);
		ft::deque<int> ft_vec_base(4, 100); ft_vec_base.push_back(500);
		std::deque<int> std_vec1;
		ft::deque<int> ft_vec1;
		...
		print_std_vec(std_vec1);
		print_ft_vec(ft_vec1);
		std::deque<int> std_vec2(23, 4);
		ft::deque<int> ft_vec2(23, 4);
...

	{
		...
		std::deque<int> std_vec1, std_vec2;
		ft::deque<int> ft_vec1, ft_vec2;
		...
		std::deque<int>::iterator std_it1 = std_vec1.begin(), std_it2 = std_vec2.begin();
		ft::deque<int>::iterator ft_it1 = ft_vec1.begin(), ft_it2 = ft_vec2.begin();
...

	{
		...
		std::deque<int> std_vec1, std_vec2, std_vec3;
		ft::deque<int> ft_vec1, ft_vec2, ft_vec3;
		...
		std::cout << "<= : " << (ft_vec1 <= ft_vec3) << std::endl;
		std::cout << ">= : " << (ft_vec1 >= ft_vec3) << std::endl;
		std::deque<int> std_vec_copy(std_vec1);
		ft::deque<int> ft_vec_copy(ft_vec1);
