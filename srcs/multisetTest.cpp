...
void print_std_set(std::multiset<std::string>& set)
{
	std::cout << "[std] multiset: " << std::endl;
	size_t i = 0;
	for (std::multiset<std::string>::iterator it = set.begin(); it != set.end(); it++) {
		std::cout << *it << " ";
		if ((i + 1) % 3 == 0)
			std::cout << std::endl;
		i++;
...
void print_ft_set(ft::multiset<std::string>& set)
{
	std::cout << "[ft] multiset: " << std::endl;
	size_t i = 0;
	for (ft::multiset<std::string>::iterator it = set.begin(); it != set.end(); it++) {
		std::cout << *it << " ";
		if ((i + 1) % 3 == 0)
			std::cout << std::endl;
		i++;
...
void	multisetTest()
{
	...
	system("clear");

	 {
	 	...
	 	std::multiset<std::string> std_set_base;
	 	ft::multiset<std::string> ft_set_base;

	 	std_set_base.insert("(1)"); std_set_base.insert("(2)"); std_set_base.insert("(3)");
	 	std_set_base.insert("(1)"); std_set_base.insert("(3)"); std_set_base.insert("(6)");
	 	std_set_base.insert("(1)"); std_set_base.insert("(8)"); std_set_base.insert("(2)");

	 	ft_set_base.insert("(1)"); ft_set_base.insert("(2)"); ft_set_base.insert("(3)");
	 	ft_set_base.insert("(1)"); ft_set_base.insert("(3)"); ft_set_base.insert("(6)");
	 	ft_set_base.insert("(1)"); ft_set_base.insert("(8)"); ft_set_base.insert("(2)");

	 	std::multiset<std::string> std_set(std_set_base.begin(), std_set_base.end());
	 	ft::multiset<std::string> ft_set(ft_set_base.begin(), ft_set_base.end());
	 	print_std_set(std_set);
	 	print_ft_set(ft_set);
	 }
...

	 {
	 	...
	 	std::cout << "[std] multiset: size = " << std_set.size() << ", empty = " << std_set.empty() << std::endl;
	 	std::cout << "[ft] multiset: size = " << ft_set.size() << ", empty = " << ft_set.empty() << std::endl;
	 	...
	 	std::multiset<int> _std_set;
	 	ft::multiset<int> _ft_set;

	 	std::cout << "with another type of multiset: [std] max_size: " << _std_set.max_size() << ", [ft] max_size: " << _ft_set.max_size() << std::endl;
	 }
...

	 {
	 	...
	 	for (std::multiset<std::string>::iterator it = std_set.begin(); it != std_set.end(); it++)
	 		std::cout << *it << " ";
	 	std::cout << std::endl << "[ft]: " << std::endl;
	 	for (ft::multiset<std::string>::iterator it = ft_set.begin(); it != ft_set.end(); it++)
	 		std::cout << *it << " ";

	 	std::cout << std::endl << "reverse iterator: ";
	 	std::cout << std::endl << "[std]: " << std::endl;
	 	for (std::multiset<std::string>::reverse_iterator it = std_set.rbegin(); it != std_set.rend(); it++)
	 		std::cout << *it << " ";
	 	std::cout << std::endl << "[ft]: " << std::endl;
	 	for (ft::multiset<std::string>::reverse_iterator it = ft_set.rbegin(); it != ft_set.rend(); it++)
	 		std::cout << *it << " ";

	 	std::multiset<std::string> std_set_const(std_set);
	 	ft::multiset<std::string> ft_set_const(ft_set);

	 	std::cout << std::endl << "const iterator: " << std::endl;
	 	std::cout << "[std]: " << std::endl;
	 	for (std::multiset<std::string>::const_iterator it = std_set_const.begin(); it != std_set_const.end(); it++)
	 		std::cout << *it << " ";
	 	std::cout << std::endl << "[ft]: " << std::endl;
	 	for (ft::multiset<std::string>::const_iterator it = ft_set_const.begin(); it != ft_set_const.end(); it++)
	 		std::cout << *it << " ";

	 	std::cout << std::endl << "const reverse iterator: " << std::endl;
	 	std::cout << "[std]: " << std::endl;
	 	for (std::multiset<std::string>::const_reverse_iterator it = std_set_const.rbegin(); it != std_set_const.rend(); it++)
	 		std::cout << *it << " ";
	 	std::cout << std::endl << "[ft]: " << std::endl;
	 	for (ft::multiset<std::string>::const_reverse_iterator it = ft_set_const.rbegin(); it != ft_set_const.rend(); it++)
	 		std::cout << *it << " ";
...

	 {
	 	...
	 	std::multiset<std::string>::iterator std_it = std_set.insert("zxc");
	 	ft::multiset<std::string>::iterator ft_it = ft_set.insert("zxc");
	 	std::cout << "[std]: elem: " << *(std_it) << std::endl;
	 	std::cout << "[ft]: elem: " << *(ft_it) << std::endl;

	 	std::cout << "insert elem with key that already exist: " << std::endl;
	 	std::multiset<std::string>::iterator std_it1 = std_set.insert("zxc");
	 	ft::multiset<std::string>::iterator ft_it1 = ft_set.insert("zxc");
	 	std::cout << "[std]: elem: " << *(std_it1) << std::endl;
	 	std::cout << "[ft]: elem: " << *(ft_it1) << std::endl;
	 	print_std_set(std_set);
	 	print_ft_set(ft_set);
	 	...
	 	std::multiset<std::string> _std_set;
	 	ft::multiset<std::string> _ft_set;
...

	 {
	 	...
	 	size_t i1 = std_set.erase("(6)");
	 	size_t i2 = ft_set.erase("(6)");
...

	 {
	 	...
	 	std::multiset<std::string> std_set1, std_set2;
	 	ft::multiset<std::string> ft_set1, ft_set2;
...

	 {
	 	...
	 	ft_set.insert("(1)"); ft_set.insert("(2)"); ft_set.insert("(3)");
	 	ft_set.insert("(4)"); ft_set.insert("(5)"); ft_set.insert("(6)");
	 	std::multiset<std::string>::key_compare std_comp = std_set.key_comp();
	 	ft::multiset<std::string>::key_compare ft_comp = ft_set.key_comp();

	 	std::cout << "[std]: " << std::endl;
	 	std::multiset<std::string>::iterator it = std_set.begin();
	 	do {
	 		if (it == std_set.end())
	 			break ;
	 		std::cout << *it << " ";
	 	...
	 	ft::multiset<std::string>::iterator it1 = ft_set.begin();
	 	do {
	 		if (it1 == ft_set.end())
	 			break ;
	 		std::cout << *it1 << " ";
...

	 {
	 	...
	 	std::cout << "find (6): " << "[std]: " << *(std_set.find("(6)")) << std::endl;
	 	std::cout << "find (6): " << "[ft]: " << *(ft_set.find("(6)")) << std::endl;
	 }
...

	 {
	 	...
	 	std::cout << "count (6): " << "[std]: " << std_set.count("(6)") << std::endl;
	 	std::cout << "count (6): " << "[ft]: " << ft_set.count("(6)") << std::endl;
...

	 {
	 	...
	 	std::multiset<std::string>::iterator std_it_low = std_set.lower_bound("(1)");
	 	std::multiset<std::string>::iterator std_it_up = std_set.lower_bound("(46)");
	 	std::cout << "[std] bounds (1, 46): " << std::endl;
	 	for ( ; std_it_low != std_it_up; std_it_low++)
	 		std::cout << *std_it_low << " ";
	 	std::cout << std::endl;

	 	ft::multiset<std::string>::iterator ft_it_low = ft_set.lower_bound("(1)");
	 	ft::multiset<std::string>::iterator ft_it_up = ft_set.lower_bound("(46)");
...

	 {
	 	...
	 	std::pair<std::multiset<std::string>::iterator, std::multiset<std::string>::iterator> std_range = std_set.equal_range("(3)");
	 	std::cout << "[std] range: (" << *(std_range.first) << ", " << *(std_range.second) << ")" << std::endl;

	 	std::pair<ft::multiset<std::string>::iterator, ft::multiset<std::string>::iterator> ft_range = ft_set.equal_range("(3)");
	 	std::cout << "[ft] range: (" << *(ft_range.first) << ", " << *(ft_range.second) << ")" << std::endl;

	 	std::pair<std::multiset<std::string>::iterator, std::multiset<std::string>::iterator> std_range1 = std_set.equal_range("(44)");
	 	std::cout << "[std] range: (" << *(std_range1.first) << ", " << *(std_range1.second) << ")" << std::endl;

	 	std::pair<ft::multiset<std::string>::iterator, ft::multiset<std::string>::iterator> ft_range1 = ft_set.equal_range("(44)");
