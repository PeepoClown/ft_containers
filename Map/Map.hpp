...
namespace ft
{
	...
	class map : public Tree<std::pair<const Key, T>, value_compare<std::pair<const Key, T>, Compare>, false>
	{
	public :
		...
		typedef typename Tree<value_type, value_compare, false>::iterator					iterator;
		typedef typename Tree<value_type, value_compare, false>::reverse_iterator			reverse_iterator;
		typedef typename Tree<value_type, value_compare, false>::const_iterator				const_iterator;
		typedef typename Tree<value_type, value_compare, false>::const_reverse_iterator		const_reverse_iterator;
		typedef ptrdiff_t																	difference_type;
		typedef size_t																		size_type;
		typedef Tree<std::pair<const Key, T>, value_compare, false>							tree;
		...
		mapped_type& operator[] (const key_type& key)
		{
			...
			if (iterator(tree::find(val)) == tree::end())
				tree::insert(val);
			return (tree::find(val)->second);
		}
