...
namespace ft
{
	...
	public :
		...
		typedef typename Tree<T, key_compare, false>::iterator					iterator;
		typedef typename Tree<T, key_compare, false>::reverse_iterator			reverse_iterator;
		typedef typename Tree<T, key_compare, false>::const_iterator			const_iterator;
		typedef typename Tree<T, key_compare, false>::const_reverse_iterator	const_reverse_iterator;
		typedef ptrdiff_t														difference_type;
		typedef size_t															size_type;
		typedef Tree<T, key_compare, false>										tree;
		typedef TreeNode<key_compare>											node;
	...
	public :
		...
		size_type erase(const key_type& key)
		{
			...
			size_type result = (tree::find(val) != tree::end()) ? 1 : 0;
			if (result == 1)
